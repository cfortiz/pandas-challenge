# pandas-challenge
Create and manipulate Pandas DataFrames to analyze school and standardized test
data.

## Files

* `Resources/schools_complete.csv`: Provided data for schools.
* `Resources/students_complete.csv`: Provided data for students.
* `cityschools.ipynb`: Jupyter notebook solving the assignment.
